    ...
    <section className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
      <div className="max-w-3xl">
        ...
        <h1 className="mt-4 text-3xl font-bold text-neutral-950 sm:text-5xl">
          A future Bardo's rewards and staff access model.
        </h1>
        <p className="mt-5 text-base leading-7 text-neutral-600">
          This concept keeps the template's local demo selector so rewards,
          staff-only menus, catering workflows, and admin checks can be wired
          before live auth is connected.
        </p>
      </div>
