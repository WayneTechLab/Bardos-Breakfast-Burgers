...
> Source of truth:
> [`.SYSTEMX/Template/WEBAPP-STACK-G1.0.md`](https://github.com/WayneTechLab/Bardos-Breakfast-Burgers/blob/main/.SYSTEMX/Template/WEBAPP-STACK-G1.0.md)
> and the per-step guides in
> [`.SYSTEMX/Template/steps/`](https://github.com/WayneTechLab/Bardos-Breakfast-Burgers/tree/main/.SYSTEMX/Template/steps).
...
| Release host | Local verification / Firebase deploy | Local verification |
...
- Local release gates are green before merge or deploy.
...
source material for detailed Firebase, payments, Functions, local QA, and deploy
instructions.
